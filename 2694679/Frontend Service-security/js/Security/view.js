        ...
        data.forEach(function (item) {
          ...
          html +=
            `<tr>
                    ...
                    <button type="button" class="btn btn-secundary" style="background-color: red;" onclick="deleteById(${item.id})"> <img src="/Frontend Service-security/assets/icon/trash3.svg" > </button></td>
                </tr>`;
          }
        });
